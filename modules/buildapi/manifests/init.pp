class buildapi {
    ...
    cron {
        ...
        "waittime-build":
            ...
            user => "buildapi",
            command => "/home/buildapi/bin/waittime_mailer.sh buildpool -a dev-tree-alerts@lists.mozilla.org -x 480",
            environment => ["MAILTO=release@mozilla.com"],
            hour => "6",
            minute => "1";
        "waittime-try":
            ...
            user => "buildapi",
            command => "/home/buildapi/bin/waittime_mailer.sh trybuildpool -a dev-tree-alerts@lists.mozilla.org -x 480",
            environment => ["MAILTO=release@mozilla.com"],
            hour => "6",
            minute => "3";
        "waittime-test":
            ...
            user => "buildapi",
            command => "/home/buildapi/bin/waittime_mailer.sh testpool -a dev-tree-alerts@lists.mozilla.org -x 480",
            environment => ["MAILTO=release@mozilla.com"],
            hour => "6",
            minute => "5";
        "running":
